...
breathe_projects = {"pgcpp": "./doxyoutput/xml"}
breathe_default_project = "pgcpp"
...
htmlhelp_basename = 'projectivedoc'
...
latex_documents = [
  (master_doc, 'pgcpp.tex', u'pgcpp Documentation',
...
man_pages = [
    (master_doc, 'pgcpp', u'pgcpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pgcpp', u'pgcpp Documentation',
   author, 'pgcpp', 'One line description of project.',
   'Miscellaneous'),
]
